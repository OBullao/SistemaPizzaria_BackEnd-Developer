...
public class UsuarioController {
    ...
    public ResponseEntity<?> cadastrar(@RequestBody Usuario cadastro) {
        try {
    ...
    public ResponseEntity<String> delete(@PathVariable Long id){
        Optional<Usuario> deletarId = Repository.findById(id);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> atualizar( @PathVariable Long id, @RequestBody Usuario atualizarId){
        try {
